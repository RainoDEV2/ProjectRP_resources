...
RegisterNetEvent('prp-clothing:client:getOutfits', function(requiredJob, gradeLevel)
    local gender = "male"
    if ProjectRP.Functions.GetPlayerData().charinfo.gender == 1 then gender = "female" end
...
RegisterNUICallback('selectOutfit', function(data)
    TriggerEvent('prp-clothing:client:loadOutfit', data)
end)
...
AddEventHandler('prp-clothing:client:openMenu', function()
    customCamLocation = nil
    openMenu({
...
RegisterNUICallback('TrackerError', function()
    ProjectRP.Functions.Notify("You can't remove your ankle bracelet ..", "error")
end)
...
RegisterNUICallback('saveOutfit', function(data, cb)
    ...
    TriggerServerEvent('prp-clothes:saveOutfit', data.outfitName, model, skinData)
end)

RegisterNetEvent('prp-clothing:client:reloadOutfits')
AddEventHandler('prp-clothing:client:reloadOutfits', function(myOutfits)
    SendNUIMessage({
...
RegisterNUICallback('removeOutfit', function(data, cb)
    TriggerServerEvent('prp-clothing:server:removeOutfit', data.outfitName, data.outfitId)
    ProjectRP.Functions.Notify("You have deleted your"..data.outfitName.." outfit!")
end)
...
function SaveSkin()
    ...
    TriggerServerEvent("prp-clothing:saveSkin", model, clothing)
end

RegisterNetEvent('prp-clothes:client:CreateFirstCharacter')
AddEventHandler('prp-clothes:client:CreateFirstCharacter', function()
...
RegisterNetEvent("prp-clothes:loadSkin")
AddEventHandler("prp-clothes:loadSkin", function(new, model, data)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('prp-clothing:client:loadPlayerClothing', data, PlayerPedId())
    end)
end)

RegisterNetEvent('prp-clothing:client:loadPlayerClothing')
AddEventHandler('prp-clothing:client:loadPlayerClothing', function(data, ped)
...
RegisterNetEvent('prp-clothing:client:loadOutfit')
AddEventHandler('prp-clothing:client:loadOutfit', function(oData)
    local ped = PlayerPedId()
    ...
    if data["accessory"] ~= nil then
        if ProjectRP.Functions.GetPlayerData().metadata["tracker"] then
    ...
    if oData.outfitName ~= nil then
        ProjectRP.Functions.Notify("You have chosen "..oData.outfitName.."! Press Confirm to confirm outfit.")
    end
end)
...
RegisterNetEvent("prp-clothing:client:adjustfacewear")
AddEventHandler("prp-clothing:client:adjustfacewear",function(type)
    if ProjectRP.Functions.GetPlayerData().metadata["ishandcuffed"] then return end
...
function reloadSkin(health)
    ...
    local gender = ProjectRP.Functions.GetPlayerData().charinfo.gender
    ...
    TriggerServerEvent("prp-clothes:loadPlayerSkin") -- LOADING PLAYER'S CLOTHES
    TriggerServerEvent("prp-clothing:loadPlayerSkin") -- LOADING PLAYER'S CLOTHES - Event 2
