...
function Animator(pedHandle, pedModel, state, options)
    ...
    -- ProjectRP.Functions.Notify(Lang:t('menu.action_menu.error.pet_unable_to_do_that'), 'error', 1500)

    -- ProjectRP.Functions.Notify(Lang:t('menu.general_menu_items.success'), 'success', 1500)
