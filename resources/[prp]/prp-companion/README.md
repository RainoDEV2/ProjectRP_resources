...
![shop](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/shop.jpg)
![petshop](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/shop2.jpg)
![tooltip](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/tooltip.jpg)
![spawn](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/call.jpg)
![menu](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/menu.jpg)
![commands](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/levelup.jpg)
![pets](https://raw.githubusercontent.com/swkeep/prp-companion/main/.github/images/pets.jpg)
...
- [prp-menu](https://github.com/qbcore-framework/prp-menu)
- [qbcore inventory](https://github.com/qbcore-framework/prp-inventory)
- [lj-inventory](https://github.com/loljoshie/lj-inventory) -- in screenshot
- [prp-shops](https://github.com/qbcore-framework/prp-shops)

# step 2: add items

-- Add this code at end of prp-core\shared\items.lua
...
- Here is tables prp-shops/config.lua
...
```javascript
    ...
    itemData.name == "companionhusky" ||
    itemData.name == "companionrottweiler" ||
    itemData.name == "companionmtlion" ||
    itemData.name == "companionmtlion2" ||
    itemData.name == "companioncat" ||
    itemData.name == "companionpoodle" ||
    itemData.name == "companionpug" ||
    itemData.name == "companionretriever" ||
    itemData.name == "companionshepherd" ||
    itemData.name == "companionwesty"
) {
