...
# prp-fuel used with PRPCore Framework
Join my Discord laboratory for updates, support, and special early testing!
<br>
https://discord.gg/loljoshie (without-vanity url: https://discord.gg/HH6uTcBfew)

prp-fuel is a modified version of LegacyFuel using PolyZones like NoPixel 3.0
<br>
...
* [polyzone](https://github.com/PRPCore-framework/PolyZone)

# Installation
* **IMPORTANT: Must rename ANY existing LegacyFuel exports to prp-fuel**

## prp-smallresources:
* Remove this thread in **prp-smallresources/client/ignore.lua**
```lua
...
* Gas station polyzone areas targeted with prp-target
...
### refuel interact
![prp-target interact](https://user-images.githubusercontent.com/91661118/139377384-0ab4a5f7-c760-4111-8512-bf8760e8d61a.png)
### menu price calculation
![prp-target interact](https://user-images.githubusercontent.com/91661118/139625411-38fde643-74ac-4be5-a26d-c1744406afb0.png)

### pump interaction
![prp-target pump interaction](https://user-images.githubusercontent.com/91661118/139377494-de7de1b5-b8e7-4c72-9b63-493ee34279bd.png)
#

# My CSS Edits to Dependencies
* [prp-target](https://github.com/loljoshie/prp-target)
* [progressbar](https://github.com/loljoshie/progressbar)
* [prp-menu](https://github.com/loljoshie/prp-menu)

# Change Logs

### 1.2
* optimize & refactor & change table & add new export - evanillaa
* Change exports back to prp-target
* Fixed prp-menu for new update
