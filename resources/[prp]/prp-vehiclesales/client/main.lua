        ...
        if ProjectRP ~= nil then
            ...
            if sellBackDist <= 13.0 and IsPedInAnyVehicle(ped) then
                ...
                if sellBackDist <= 3.5 and IsPedInAnyVehicle(ped) then
                    ...
                    DrawText3Ds(Config.SellVehicleBack.x, Config.SellVehicleBack.y, Config.SellVehicleBack.z, '[~g~E~w~] - Sell Vehicle To Dealer For ~g~$'..math.floor(sellVehData.price * Config.SellAmount))
