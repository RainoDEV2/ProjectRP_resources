var app = new Vue({
    ...
    methods: {
        sell(sellPrice) {
            ...
            if (this.sellPrice != "") {
                if (!isNaN(sellPrice)) {
                    ...
                    fetch("https://prp-vehiclesales/sellVehicle", requestOptions);
                    this.close();
                } else {
        ...
        buy() {
            ...
            fetch("https://prp-vehiclesales/buyVehicle", requestOptions);
            this.close();
        },
        close() {            
            const requestOptions = {
            ...
            fetch("https://prp-vehiclesales/close", requestOptions);
            // .then(function(msg) {
            //     console.log(msg);
