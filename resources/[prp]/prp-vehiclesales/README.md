# prp-vehiclesales
Used Car Sale for prp-Core Framework :blue_car:
...
- [prp-garages](https://github.com/ProjectRP-framework/prp-garages) - Vehicle ownership
- [prp-phone](https://github.com/ProjectRP-framework/prp-phone) - For the e-mail
- [prp-logs](https://github.com/ProjectRP-framework/prp-logs) - Keep event logs
...
- Import `prp-vehiclesales.sql` in your database
...
ensure prp-vehiclesales
```

## Configuration
- To adjust tax, go to prp-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
