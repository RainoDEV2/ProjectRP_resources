...
ProjectRP.Functions.CreateCallback('mc-storage/server/get-config', function(source, cb)
	cb(Config)   
end)

ProjectRP.Functions.CreateCallback('check-pincode', function(source, cb, Code, ContainerId)
