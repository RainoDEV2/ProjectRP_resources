...
Config.OxyChance = 750 -- Percentage chance of getting oxy on the run. Multiplied by 100. 10% = 100, 20% = 200, 50% = 500, etc. Default 55%.
Config.OxyAmount = 5 -- How much oxy you get when RN Jesus gives you oxy. Default: 1.
