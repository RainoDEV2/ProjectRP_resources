...
$(document).ready(function() {
    ...
    window.addEventListener('click',function() {
        ...
        if (distance < HitDistance) {
            ...
            MainDigits--;
            $.post("https://prp-bankrobbery/thermiteclick");
...
Thermite.Failed = function() {
    if (active) $.post("https://prp-bankrobbery/thermitefailed");
    active = false;
    Thermite.Close();
}

Thermite.Success = function() {
    if (active) $.post("https://prp-bankrobbery/thermitesuccess");
    active = false;
    Thermite.Close();
}
...
Thermite.Close = function() {
    ...
    $.post('https://prp-bankrobbery/closethermite');
}