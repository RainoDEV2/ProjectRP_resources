RegisterNetEvent('prp-bankrobbery:client:ClearTimeoutDoors', function()
    TriggerServerEvent('prp-doorlock:server:updateState', 85, true)
    ...
    while true do
        ...
        if PaletoDist < 15 then
            ...
            if Config.BigBanks["paleto"]["isOpened"] then
                TriggerServerEvent('prp-doorlock:server:updateState', 85, false)
