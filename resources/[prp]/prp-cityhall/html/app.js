...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $.post('https://prp-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    ...
    $.post('https://prp-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post('https://prp-cityhall/applyJob', JSON.stringify({
        job: selectedJobId
    }))
