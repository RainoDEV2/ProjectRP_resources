...
RegisterNetEvent('prp-cityhall:client:getIds')
AddEventHandler('prp-cityhall:client:getIds', function()
    TriggerServerEvent('prp-cityhall:server:getIDs')
end)

RegisterNetEvent('prp-cityhall:client:OpenCityMenu')
AddEventHandler('prp-cityhall:client:OpenCityMenu', function()
    qbCityhall.Open()
end)
...
RegisterNUICallback('requestId', function(data)
        ...
        ProjectRP.Functions.Notify('You have recived your '..idTypes[idType].label..' for $50', 'success', 3500)
...
RegisterNUICallback('applyJob', function(data)
       ...
       -- ProjectRP.Functions.Notify('Unfortunately will not work ...', 'error')
end)
