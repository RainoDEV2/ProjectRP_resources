print("prp-Recycle - Recycling Script by Jimathy")
...
Config.Locations =  {
	['Recycle'] = { name = "Recycle Center", location = vector3(56.3, 6341.33, 30.36), heading = 338.73, blipTrue = true, Sprite = 365, Scale = 0.8, Colour = 2, }, -- The location where you enter the mine 
	...
	['BottleBank'] = { name = "Bottle Bank", location = vector3(69.7, 6354.96, 30.38), heading = 75.2, blipTrue = false, Sprite = 642, Scale = 0.8, Colour = 2,}, -- The location where you enter the mine 
