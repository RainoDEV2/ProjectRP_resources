...
Config.Rewards = {
    [1] = {
        ...
        ["chest"] = {"plastic", "rolex", "diamond_ring", "green-card", "goldchain", "weed_skunk", "thermite", "cryptostick", "weapon_combatpistol"},
        ["livingroom"] = {"plastic", "rolex", "diamond_ring", "thermite", "cryptostick", "tablet", "pistol_ammo"}
    }
}
