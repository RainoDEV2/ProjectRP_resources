	...
	if not ply.state.inv_busy then
		if name ~= nil and id ~= nil then
			...
			elseif name == "trunk" then
				...
				if (Trunks[id] ~= nil and Trunks[id].isOpen) or (ProjectRP.Shared.SplitStr(id, "POLICE")[2] ~= nil and Player.PlayerData.job.name ~= "police") then
					secondInv.name = "none-inv"
...
ProjectRP.Commands.Add("trunkpos", "View Trunk Location", {}, false, function(source, args)
