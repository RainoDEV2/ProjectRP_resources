...
Update v1.3:
	- Changed to new versions of systems
		...
		- Uses Icons in prp-menu now
		- Fixes any issues with making food and drinks
		- Install Checks to see if any items are missing.
	- Added image support for prp-payments cash register

Update v1.2:
	- Payment systems removed/changed in favour of support for my free payment script prp-payments: https://github.com/jimathy/prp-payments#
	...
	- Fixed typo in a hand washing prp-target location
	- Several QoL fixes I've lost track of
	- Removed doubled up cat from ledge near staff door
	- Rearranged prp-menu layout
	- Added item checkmarks to prp-menu's to show if you have the required items or not
...
UPDATE v1.1:
  ...
  - Complete rewrite of the payment system, now using prp-menu and prp-phone
...
Within the config.lua of prp-bossmenu
