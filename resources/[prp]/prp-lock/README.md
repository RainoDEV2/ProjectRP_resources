# prp-lockpick
 NoPixel Based Lockpick for PRPFramework
 all credits go to FjamZoo#0001, i only did an nopixel inpired reskin


# Template
exports['prp-lock']:StartLockPickCircle(amount, time, function(success)
...
RegisterCommand("lpgame", function()
	...
	local success = exports['prp-lock']:StartLockPickCircle(circles, time, success)
	print(success)
	if success then
		print("WIN")
	else
