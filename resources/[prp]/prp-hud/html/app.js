...
function closeMenu() {
  ...
  $.post('https://prp-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://prp-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://prp-hud/resetStorage');
}
function showOutMap() {
  $.post('https://prp-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://prp-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://prp-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://prp-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://prp-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://prp-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://prp-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://prp-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://prp-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://prp-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://prp-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://prp-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://prp-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://prp-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://prp-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://prp-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://prp-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://prp-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://prp-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://prp-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://prp-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://prp-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://prp-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://prp-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://prp-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://prp-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://prp-hud/cinematicMode');
}
