...
RegisterNetEvent('prison:client:Enter', function(time)
	...
	Wait(2000)
	DoScreenFadeIn(1000)
	ProjectRP.Functions.Notify("Do some work for sentence reduction, instant job: "..Config.Jobs[currentJob])
end)

RegisterNetEvent('prison:client:Leave', function()
	if jailTime > 0 then
		ProjectRP.Functions.Notify("You still have to... "..jailTime.." months..")
	else
		jailTime = 0
