...
local Drawables = {
    ...
    ["Shoes"] = {
        Drawable = 6,
        Table = {Standalone = true, Male = 73, Female = 64},
...
local Extras = {
    ["Shirt"] = {
        Drawable = 11,
        Table = {
            Standalone = true, Male = 15, Female = 129,
            Extra = { 
...
RegisterNetEvent('prp-radialmenu:ResetClothing')
AddEventHandler('prp-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('prp-radialmenu:ToggleClothing')
AddEventHandler('prp-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('prp-radialmenu:ToggleProps')
AddEventHandler('prp-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	ProjectRP.Functions.Notify(message, color)
end
