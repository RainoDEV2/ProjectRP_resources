...
--========================================================== Tires
RegisterNetEvent('prp-mechanic:client:Tires:Apply', function(data)
	...
	if r == data.R and g == data.G and b == data.B then
		TriggerEvent("ProjectRP:Notify", Loc[Config.Lan]["smoke"].already, "error")
		TriggerEvent('prp-mechanic:client:Tires:Check')
	else
		...
		ProjectRP.Functions.Progressbar("drink_something", Loc[Config.Lan]["smoke"].installing, time, false, true, { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = false, }, 
		{ animDict = "anim@amb@clubhouse@tutorial@bkr_tut_ig3@", anim = "machinic_loop_mechandplayer", flags = 8, }, {}, {}, function()
			...
			updateCar(vehicle)
			TriggerEvent('prp-mechanic:client:Tires:Check')
			TriggerEvent("ProjectRP:Notify", Loc[Config.Lan]["smoke"].installed, "success")
			spraying = false
		end, function() -- Cancel
			TriggerEvent("ProjectRP:Notify", Loc[Config.Lan]["smoke"].failed, "error")
			emptyHands(playerPed)
			spraying = false
		end)
	end
...
RegisterNetEvent('prp-mechanic:client:Tires:Check', function()
	...
	exports['prp-menu']:openMenu({
		...
		{ header = Loc[Config.Lan]["smoke"].remove, txt = applied15, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 0, G = 0, B = 0 } } },
		{ header = Loc[Config.Lan]["smoke"].custom, txt = applied0, params = { event = "prp-mechanic:client:smokeCustomMenu", } },
		{ header = Loc[Config.Lan]["smoke"].black, txt = applied1, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 1, G = 1, B = 1 } } },
		{ header = Loc[Config.Lan]["smoke"].white, txt = applied2, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 255, B = 255 } } },
		{ header = Loc[Config.Lan]["smoke"].blue, txt = applied3, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 2, G = 21, B = 255 } } },
		{ header = Loc[Config.Lan]["smoke"].eblue, txt = applied4, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 3, G = 83, B = 255 } } },
		{ header = Loc[Config.Lan]["smoke"].mgreen, txt = applied5, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 0, G = 255, B = 140 } } },
		{ header = Loc[Config.Lan]["smoke"].lgreen, txt = applied6, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 94, G = 255, B = 1 } } },
		{ header = Loc[Config.Lan]["smoke"].yellow, txt = applied7, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 255, B = 0 } } },
		{ header = Loc[Config.Lan]["smoke"].gshower, txt = applied8, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 150, B = 0 } } },
		{ header = Loc[Config.Lan]["smoke"].orange, txt = applied9,  params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 62, B = 0 } } },
		{ header = Loc[Config.Lan]["smoke"].red, txt = applied10, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 1, B = 1 } } },
		{ header = Loc[Config.Lan]["smoke"].ppink, txt = applied11, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 50, B = 100 } } },
		{ header = Loc[Config.Lan]["smoke"].hpink, txt = applied12, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 255, G = 5, B = 190 } } },
		{ header = Loc[Config.Lan]["smoke"].purple, txt = applied13, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 35, G = 1, B = 255 } } },
		{ header = Loc[Config.Lan]["smoke"].blacklight, txt = applied14, params = { event = "prp-mechanic:client:Tires:Apply", args = { R = 15, G = 3, B = 255 } } },
	})
end)

RegisterNetEvent('prp-mechanic:client:smokeCustomMenu', function()
    ...
    if dialog then
		...
		TriggerEvent('prp-mechanic:client:Tires:Apply', data)
    end
end)