...
--========================================================== Exterior
RegisterNetEvent('prp-mechanic:client:Exterior:Apply', function(data)
	...
	if GetVehicleMod(vehicle, tonumber(data.mod)) == tonumber(data.id) then
		...
		TriggerEvent('prp-mechanic:client:Exterior:Choose', data)
	elseif GetVehicleMod(vehicle, tonumber(data.mod)) ~= tonumber(data.id) then
		...
		{ animDict = "anim@amb@clubhouse@tutorial@bkr_tut_ig3@", anim = "machinic_loop_mechandplayer", flags = 8, }, {}, {}, function()
			...
			updateCar(vehicle)
			TriggerEvent('prp-mechanic:client:Exterior:Choose', data)
			TriggerEvent("ProjectRP:Notify", Loc[Config.Lan]["exterior"].installed, "success")
		end, function() -- Cancel
			TriggerEvent("ProjectRP:Notify", Loc[Config.Lan]["exterior"].failed, "error")
			emptyHands(playerPed)
		end)
	end
end)

RegisterNetEvent('prp-mechanic:client:Exterior:Check', function()
	...
	if DoesEntityExist(vehicle) then
		...
		if external ~= true then TriggerEvent("ProjectRP:Notify", Loc[Config.Lan]["common"].noOptions, "error") return end
		local ExteriorMenu = {
		...
		if GetNumVehicleMods(vehicle, 27) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label1, txt = "["..(GetNumVehicleMods(vehicle, 27)+1)..Loc[Config.Lan]["common"].menuinstalled..installed2, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 27 } } } end
		...
		if GetNumVehicleMods(vehicle, 44) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label2, txt = "["..(GetNumVehicleMods(vehicle, 44)+1)..Loc[Config.Lan]["common"].menuinstalled..installed3, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 44 } } } end
		...
		if GetNumVehicleMods(vehicle, 37) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label3, txt = "["..(GetNumVehicleMods(vehicle, 37)+1)..Loc[Config.Lan]["common"].menuinstalled..installed4, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 37 } } } end
		...
		if GetNumVehicleMods(vehicle, 39) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label4, txt = "["..(GetNumVehicleMods(vehicle, 39)+1)..Loc[Config.Lan]["common"].menuinstalled..installed5, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 39 } } } end
		...
		if GetNumVehicleMods(vehicle, 40) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label5, txt = "["..(GetNumVehicleMods(vehicle, 40)+1)..Loc[Config.Lan]["common"].menuinstalled..installed6, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 40 } } } end
		...
		if GetNumVehicleMods(vehicle, 41) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label6, txt = "["..(GetNumVehicleMods(vehicle, 41)+1)..Loc[Config.Lan]["common"].menuinstalled..installed7, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 41 } } } end
		...
		if GetNumVehicleMods(vehicle, 38) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label7, txt = "["..(GetNumVehicleMods(vehicle, 38)+1)..Loc[Config.Lan]["common"].menuinstalled..installed8, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 38 } } } end
		...
		if GetNumVehicleMods(vehicle, 42) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label8, txt = "["..(GetNumVehicleMods(vehicle, 42)+1)..Loc[Config.Lan]["common"].menuinstalled..installed9, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 42 } } } end
		...
		if GetNumVehicleMods(vehicle, 45) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label9, txt = "["..(GetNumVehicleMods(vehicle, 45)+1)..Loc[Config.Lan]["common"].menuinstalled..installed10, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 45 } } } end
		...
		if GetNumVehicleMods(vehicle, 43) ~= 0 then ExteriorMenu[#ExteriorMenu + 1] = { header = Loc[Config.Lan]["exterior"].label10, txt = "["..(GetNumVehicleMods(vehicle, 43)+1)..Loc[Config.Lan]["common"].menuinstalled..installed11, params = { event = "prp-mechanic:client:Exterior:Choose", args = { mod = 43 } } } end
	
		exports['prp-menu']:openMenu(ExteriorMenu)
	end
end)

RegisterNetEvent('prp-mechanic:client:Exterior:Choose', function(data)
	local playerPed	= PlayerPedId()
    local coords = GetEntityCoords(playerPed)
	local validMods = {}
	if not inCar() then return end
	...
	if DoesEntityExist(vehicle) then
		...
		local ModMenu = {
				...
				{ header = "", txt = Loc[Config.Lan]["common"].ret, params = { event = "prp-mechanic:client:Exterior:Check" } },
				{ header = "0. "..Loc[Config.Lan]["common"].stock, txt = stockinstall,	params = { event = "prp-mechanic:client:Exterior:Apply", args = { id = -1, mod = tonumber(data.mod) } }	} }
			for k,v in pairs(validMods) do
				ModMenu[#ModMenu + 1] = { header = k..". "..v.name, txt = v.install, params = { event = 'prp-mechanic:client:Exterior:Apply', args = { id = v.id, mod = data.mod } } }
			end
