...
--========================================================== Repair
RegisterNetEvent('prp-mechanic:quickrepair', function()
	...
	if DoesEntityExist(vehicle) then
		...
		if repaireng or repairbody then
			...
			ProjectRP.Functions.Progressbar("drink_something", Loc[Config.Lan]["repair"].applyduct, 10000, false, true, { disableMovement = true, disableCarMovement = true, disableMouse = false, disableCombat = false, },
			...
			{}, {}, function()
				...
				if Config.RemoveDuctTape then TriggerServerEvent("prp-mechanic:server:removeTape") end
			end, function()
				SetVehicleDoorShut(vehicle, 4, false, false)
				emptyHands(playerPed)
			end)
