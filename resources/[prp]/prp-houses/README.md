# prp-houses
Real Estate for prp-Core Framework :house_with_garden:
...
- [prp-radialmenu](https://github.com/ProjectRP-framework/prp-radialmenu) - For the menu in screenshots
- [prp-anticheat](https://github.com/ProjectRP-framework/prp-anticheat) - Anti Cheat 
- [prp-phone](https://github.com/ProjectRP-framework/prp-phone) - Houses app
- [prp-multicharacter](https://github.com/ProjectRP-framework/prp-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [prp-garages](https://github.com/ProjectRP-framework/prp-garages) - House Garage
- [prp-interior](https://github.com/ProjectRP-framework/prp-interior) - Necessary for house interiors
- [prp-clothing](https://github.com/ProjectRP-framework/prp-clothing) - Outfits
- [prp-weathersync](https://github.com/ProjectRP-framework/prp-weathersync) - Desync weather inside house
- [prp-weed](https://github.com/ProjectRP-framework/prp-weed) - Weed plant
- [prp-skillbar](https://github.com/ProjectRP-framework/prp-skillbar) - Skills
...
- Import `prp-houses.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure prp-core
ensure prp-radialmenu
ensure prp-anticheat
ensure prp-phone
