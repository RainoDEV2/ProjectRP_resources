...
local function SetClosestHouse()
    ...
    if not inside then
        ...
        if closesthouse ~= nil and tonumber(dist) < 30 then
            ProjectRP.Functions.TriggerCallback('prp-houses:server:ProximityKO', function(key, owned)
                hasKey = key
                isOwned = owned
            end, closesthouse)
        end
...
local function setHouseLocations()
    if closesthouse ~= nil then
        ProjectRP.Functions.TriggerCallback('prp-houses:server:getHouseLocations', function(result)
            if result ~= nil then
...
local function LoadDecorations(house)
	if Config.Houses[house].decorations == nil or next(Config.Houses[house].decorations) == nil then
		ProjectRP.Functions.TriggerCallback('prp-houses:server:getHouseDecorations', function(result)
...
function HouseKeysMenu()
    ...
    MenuTitle = "Sleutels"
    ClearMenu()
    ProjectRP.Functions.TriggerCallback('prp-houses:server:getHouseKeyHolders', function(holders)
        ped = PlayerPedId();
        MenuTitle = "Sleutelhouders:"
        ClearMenu()
        if holders == nil or next(holders) == nil then
            ProjectRP.Functions.Notify("No key holders found..", "error", 3500)
            closeMenuFull()
        else
...
local function getDataForHouseTier(house, coords)
    if Config.Houses[house].tier == 1 then
        return exports['prp-interior']:CreateApartmentShell(coords)
    elseif Config.Houses[house].tier == 2 then
        return exports['prp-interior']:CreateTier1House(coords)
    elseif Config.Houses[house].tier == 3 then
        return exports['prp-interior']:CreateTrevorsShell(coords)
    elseif Config.Houses[house].tier == 4 then
        return exports['prp-interior']:CreateCaravanShell(coords)
...
--         return exports['prp-interior']:CreateFranklinAunt(coords)
--     elseif Config.Houses[house].tier == 8 then
--         return exports['prp-interior']:CreateMedium2(coords)
--     elseif Config.Houses[house].tier == 9 then
--         return exports['prp-interior']:CreateMedium3(coords)
--     elseif Config.Houses[house].tier == 10 then
--         return exports['prp-interior']:CreateBanham(coords)
--     elseif Config.Houses[house].tier == 11 then
--         return exports['prp-interior']:CreateWestons(coords)
--     elseif Config.Houses[house].tier == 12 then
--         return exports['prp-interior']:CreateWestons2(coords)
--     elseif Config.Houses[house].tier == 13 then
--         return exports['prp-interior']:CreateClassicHouse(coords)
--     elseif Config.Houses[house].tier == 14 then
--         return exports['prp-interior']:CreateClassicHouse2(coords)
--     elseif Config.Houses[house].tier == 15 then
--         return exports['prp-interior']:CreateClassicHouse3(coords)
--     elseif Config.Houses[house].tier == 16 then
--         return exports['prp-interior']:CreateHighend1(coords)
--     elseif Config.Houses[house].tier == 17 then
--         return exports['prp-interior']:CreateHighend2(coords)
--     elseif Config.Houses[house].tier == 18 then
--         return exports['prp-interior']:CreateHighend3(coords)
--     elseif Config.Houses[house].tier == 19 then
--         return exports['prp-interior']:CreateHighend(coords)
--     elseif Config.Houses[house].tier == 20 then
--         return exports['prp-interior']:CreateHighendV2(coords)
--     elseif Config.Houses[house].tier == 21 then
--         return exports['prp-interior']:CreateMichael(coords)
--     elseif Config.Houses[house].tier == 22 then
--         return exports['prp-interior']:CreateStashHouse(coords)
--     elseif Config.Houses[house].tier == 23 then
--         return exports['prp-interior']:CreateStashHouse2(coords)
--     elseif Config.Houses[house].tier == 24 then
--         return exports['prp-interior']:CreateContainer(coords)
--     elseif Config.Houses[house].tier == 25 then
--         return exports['prp-interior']:CreateGarageLow(coords)
--     elseif Config.Houses[house].tier == 26 then
--         return exports['prp-interior']:CreateGarageMed(coords)
--     elseif Config.Houses[house].tier == 27 then
--         return exports['prp-interior']:CreateGarageHigh(coords)
--     elseif Config.Houses[house].tier == 28 then
--         return exports['prp-interior']:CreateOffice1(coords)
--     elseif Config.Houses[house].tier == 29 then
--         return exports['prp-interior']:CreateOffice2(coords)
--     elseif Config.Houses[house].tier == 30 then
--         return exports['prp-interior']:CreateOfficeBig(coords)
--     elseif Config.Houses[house].tier == 31 then
--         return exports['prp-interior']:CreateBarber(coords)
--     elseif Config.Houses[house].tier == 32 then
--         return exports['prp-interior']:CreateGunstore(coords)
--     elseif Config.Houses[house].tier == 33 then
--         return exports['prp-interior']:CreateStore1(coords)
--     elseif Config.Houses[house].tier == 34 then
--         return exports['prp-interior']:CreateStore2(coords)
--     elseif Config.Houses[house].tier == 35 then
--         return exports['prp-interior']:CreateStore3(coords)
--     elseif Config.Houses[house].tier == 36 then
--         return exports['prp-interior']:CreateWarehouse1(coords)
--     elseif Config.Houses[house].tier == 37 then
--         return exports['prp-interior']:CreateWarehouse2(coords)
--     elseif Config.Houses[house].tier == 38 then
--         return exports['prp-interior']:CreateWarehouse3(coords)
--     elseif Config.Houses[house].tier == 39 then
--         return exports['prp-interior']:CreateK4Coke(coords)
--     elseif Config.Houses[house].tier == 40 then
--         return exports['prp-interior']:CreateK4Meth(coords)
--     elseif Config.Houses[house].tier == 41 then
--         return exports['prp-interior']:CreateK4Weed(coords)
--     elseif Config.Houses[house].tier == 42 then
--         return exports['prp-interior']:CreateContainer2(coords)
--     elseif Config.Houses[house].tier == 43 then
--         return exports['prp-interior']:CreateFurniStash1(coords)
--     elseif Config.Houses[house].tier == 44 then
--         return exports['prp-interior']:CreateFurniStash3(coords)
--     elseif Config.Houses[house].tier == 45 then
--         return exports['prp-interior']:CreateFurniLow(coords)
--     elseif Config.Houses[house].tier == 46 then
--         return exports['prp-interior']:CreateFurniMid(coords)
--     elseif Config.Houses[house].tier == 47 then
--         return exports['prp-interior']:CreateFurniMotel(coords)
--     elseif Config.Houses[house].tier == 48 then
--         return exports['prp-interior']:CreateFurniMotelClassic(coords)
--     elseif Config.Houses[house].tier == 49 then
--         return exports['prp-interior']:CreateFurniMotelStandard(coords)
--     elseif Config.Houses[house].tier == 50 then
--         return exports['prp-interior']:CreateFurniMotelHigh(coords)
--     elseif Config.Houses[house].tier == 51 then
--         return exports['prp-interior']:CreateFurniMotelModern(coords)
--     elseif Config.Houses[house].tier == 52 then
--         return exports['prp-interior']:CreateFurniMotelModern2(coords)
--     elseif Config.Houses[house].tier == 53 then
--         return exports['prp-interior']:CreateFurniMotelModern3(coords)
--     elseif Config.Houses[house].tier == 54 then
--         return exports['prp-interior']:CreateCoke(coords)
--     elseif Config.Houses[house].tier == 55 then
--         return exports['prp-interior']:CreateCoke2(coords)
--     elseif Config.Houses[house].tier == 56 then
--         return exports['prp-interior']:CreateMeth(coords)
--     elseif Config.Houses[house].tier == 57 then
--         return exports['prp-interior']:CreateWeed(coords)
--     elseif Config.Houses[house].tier == 58 then
--         return exports['prp-interior']:CreateWeed2(coords)
--     else
--         ProjectRP.Functions.Notify('Invalid House Tier', 'error')
--     end
-- end
...
RegisterNetEvent('prp-houses:server:sethousedecorations', function(house, decorations)
...
RegisterNetEvent('prp-houses:client:sellHouse', function()
    if closesthouse and hasKey then
        TriggerServerEvent('prp-houses:server:viewHouse', closesthouse)
    end
end)

RegisterNetEvent('prp-houses:client:EnterHouse', function()
    local ped = PlayerPedId()
...
RegisterNetEvent('prp-houses:client:RequestRing', function()
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
...
AddEventHandler('ProjectRP:Client:OnPlayerLoaded', function()
    ...
    if Config.UnownedBlips then TriggerEvent('prp-houses:client:setupHouseBlips2') end
    Citizen.Wait(100)
    TriggerEvent('prp-garages:client:setHouseGarage', closesthouse, hasKey)
...
RegisterNetEvent('prp-houses:client:lockHouse', function(bool, house)
    Config.Houses[house].locked = bool
end)

RegisterNetEvent('prp-houses:client:createHouses', function(price, tier)
    ...
    if Config.UnownedBlips then TriggerServerEvent('prp-houses:server:createBlip') end
end)

RegisterNetEvent('prp-houses:client:addGarage', function()
    if closesthouse ~= nil then
        local pos = GetEntityCoords(PlayerPedId())
        local heading = GetEntityHeading(PlayerPedId())
        local coords = {
        ...
        TriggerServerEvent('prp-houses:server:addGarage', closesthouse, coords)
    else
        ProjectRP.Functions.Notify("No house around..", "error")
    end
end)

RegisterNetEvent('prp-houses:client:toggleDoorlock', function()
    local pos = GetEntityCoords(PlayerPedId())
    local dist = #(pos - vector3(Config.Houses[closesthouse].coords.enter.x, Config.Houses[closesthouse].coords.enter.y, Config.Houses[closesthouse].coords.enter.z))
    if dist < 1.5 then
        if hasKey then
            if Config.Houses[closesthouse].locked then
                ...
                ProjectRP.Functions.Notify("House is unlocked!", "success", 2500)
            else
                TriggerServerEvent('prp-houses:server:lockHouse', true, closesthouse)
                ProjectRP.Functions.Notify("House is locked!", "error", 2500)
            end
        else
            ProjectRP.Functions.Notify("You don't have the keys of the house...", "error", 3500)
        end
    else
        ProjectRP.Functions.Notify("There is no door nearby", "error", 3500)
    end
end)

RegisterNetEvent('prp-houses:client:RingDoor', function(player, house)
    if closesthouse == house and inside then
        CurrentDoorBell = player
        TriggerServerEvent("InteractSound_SV:PlayOnSource", "doorbell", 0.1)
        ProjectRP.Functions.Notify("Someone is ringing the door!")
    end
end)

RegisterNetEvent('prp-houses:client:giveHouseKey', function(data)
    ...
    if player ~= -1 and distance < 2.5 and closesthouse ~= nil then
        ...
        if housedist < 10 then
            ...
            ProjectRP.Functions.Notify("You're not close enough to the door..", "error")
        end
    elseif closesthouse == nil then
        ProjectRP.Functions.Notify("There is no house near you", "error")
    else
        ProjectRP.Functions.Notify("No one around!", "error")
    end
end)

RegisterNetEvent('prp-houses:client:removeHouseKey', function(data)
    if closesthouse ~= nil then
        local pedpos = GetEntityCoords(PlayerPedId())
        local housedist = #(pedpos - vector3(Config.Houses[closesthouse].coords.enter.x, Config.Houses[closesthouse].coords.enter.y, Config.Houses[closesthouse].coords.enter.z))
        if housedist < 5 then
            ProjectRP.Functions.TriggerCallback('prp-houses:server:getHouseOwner', function(result)
                if ProjectRP.Functions.GetPlayerData().citizenid == result then
                    inHoldersMenu = true
                    HouseKeysMenu()
                    Menu.hidden = not Menu.hidden
                else
                    ProjectRP.Functions.Notify("You're not a house owner..", "error")
                end
            end, closesthouse)
        else
            ProjectRP.Functions.Notify("You're not close enough to the door..", "error")
...
RegisterNetEvent('prp-houses:client:refreshHouse', function(data)
    Citizen.Wait(100)
    SetClosestHouse()
end)

RegisterNetEvent('prp-houses:client:SpawnInApartment', function(house)
    local pos = GetEntityCoords(PlayerPedId())
...
RegisterNetEvent('prp-houses:client:enterOwnedHouse', function(house)
...
RegisterNetEvent('prp-houses:client:LastLocationHouse', function(houseId)
    ProjectRP.Functions.GetPlayerData(function(PlayerData)
		if PlayerData.metadata["injail"] == 0 then
...
RegisterNetEvent('prp-houses:client:setupHouseBlips', function() -- Setup owned on load
    Citizen.CreateThread(function()
        Citizen.Wait(2000)
        if LocalPlayer.state['isLoggedIn'] then
            ProjectRP.Functions.TriggerCallback('prp-houses:server:getOwnedHouses', function(ownedHouses)
                if ownedHouses then
...
RegisterNetEvent('prp-houses:client:setupHouseBlips2', function() -- Setup unowned on load
...
RegisterNetEvent('prp-houses:client:createBlip', function(coords) -- Create unowned on command
...
RegisterNetEvent('prp-houses:client:refreshBlips', function() -- Refresh unowned on buy
    for k,v in pairs(UnownedHouseBlips) do RemoveBlip(v) end
    Wait(250)
    TriggerEvent('prp-houses:client:setupHouseBlips2')
end)

RegisterNetEvent('prp-houses:client:SetClosestHouse', function()
    SetClosestHouse()
end)

RegisterNetEvent('prp-houses:client:viewHouse', function(houseprice, brokerfee, bankfee, taxes, firstname, lastname)
...
RegisterNetEvent('prp-houses:client:setLocation', function(data)
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    ...
    if inside then
        if hasKey then
            ...
            ProjectRP.Functions.Notify('You do not own this house', 'error')
        end
    else
        ProjectRP.Functions.Notify('You are not in a house', 'error')
    end
end)

RegisterNetEvent('prp-houses:client:refreshLocations', function(house, location, type)
...
RegisterNetEvent('prp-houses:client:HomeInvasion', function()
    ...
    if closesthouse ~= nil then
        ProjectRP.Functions.TriggerCallback('police:server:IsPoliceForcePresent', function(IsPresent)
            if IsPresent then
                local dist = #(pos - vector3(Config.Houses[closesthouse].coords.enter.x, Config.Houses[closesthouse].coords.enter.y, Config.Houses[closesthouse].coords.enter.z))
                ...
                if dist < 1 then
                    if Config.Houses[closesthouse].locked then
                        if not Config.Houses[closesthouse].IsRaming then
                            ...
                            ProjectRP.Functions.Notify('Someone is already working on the door..', 'error')
                        end
                    else
                        ProjectRP.Functions.Notify('19/5000 This house is already open..', 'error')
                    end
                else
                    ProjectRP.Functions.Notify('You\'re not near a house..', 'error')
                end
            else
                ProjectRP.Functions.Notify('There is no police force present..', 'error')
            end
        end)
    else
        ProjectRP.Functions.Notify('You\'re not near a house..', 'error')
...
RegisterNetEvent('prp-houses:client:SetRamState', function(bool, house)
    Config.Houses[house].IsRaming = bool
end)

RegisterNetEvent('prp-houses:client:SetHouseRammed', function(bool, house)
    Config.Houses[house].IsRammed = bool
end)

RegisterNetEvent('prp-houses:client:ResetHouse', function()
    if closesthouse ~= nil then
        ...
        if Config.Houses[closesthouse].IsRammed then
            ...
            TriggerServerEvent('prp-houses:server:lockHouse', true, closesthouse)
            RamsDone = 0
            ProjectRP.Functions.Notify('You locked the house again..', 'success')
        else
            ProjectRP.Functions.Notify('This door is not broken open ..', 'error')
        end
    end
end)
...
RegisterNUICallback('HasEnoughMoney', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-houses:server:HasEnoughMoney', function(hasEnough)
    end, data.objectData)
end)
...
RegisterNUICallback('buy', function()
    ...
    if Config.UnownedBlips then TriggerEvent('prp-houses:client:refreshBlips') end
