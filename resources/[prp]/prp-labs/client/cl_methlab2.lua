CreateThread(function()
    exports["prp-target"]:AddBoxZone("meth2entrance", Config.Labs.methlab2.entrance.xyz, 0.4, 1.2, {
        name = "meth2entrance",
    ...
    exports["prp-target"]:AddBoxZone("meth2exit", Config.Labs.methlab2.exit.xyz, 0.4, 1.2, {
        name = "meth2exit",
    ...
    exports['prp-target']:AddBoxZone("meth2ingredients", vector3(969.56, -146.53, -49.0), 0.8, 2.6, {
    ...
    exports["prp-target"]:AddCircleZone("meth2task1", vector3(978.2, -147.34, -49.02), 1.0, {
        name = "meth2task1",
        useZ = true,
        debugPoly = false
        }, {
    ...
    exports["prp-target"]:AddBoxZone("meth2task2", vector3(983.75, -143.71, -49.0), 0.8, 2.6, {
        name = "meth2task2",
        heading = 180.00,
        debugPoly = false,
        minZ = -50.00,
    ...
    exports["prp-target"]:AddBoxZone("meth2task3", vector3(983.73, -145.96, -49.0), 0.8, 2.6, {
        name = "meth2task3",
        heading = 0.00,
        debugPoly = false,
        minZ = -50.00,
    ...
    exports["prp-target"]:AddBoxZone("meth2taskend", vector3(979.38, -144.08, -50.0), 0.4, 1.2, {
        name = "meth2taskend",
        heading = 270.00,
        debugPoly = false,
        minZ = -49.30,
        maxZ = -48.00,
            ...
            {
                action = function()
                    TriggerServerEvent('prp-labs:server:FinishLab', "methlab2")
                end,
                icon = "fas fa-glasses",
                label = 'Inspect Machine',
                canInteract = function()
    ...
    exports["prp-target"]:AddBoxZone("meth2curing", vector3(980.43, -140.79, -46.75), 0.7, 1.6, {
        name = "meth2curing",
        heading = 0.00,
        debugPoly = false,
        minZ = -49.75,
