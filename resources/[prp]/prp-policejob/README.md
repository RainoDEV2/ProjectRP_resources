# prp-policejob
Police Job for prp-Core Framework :police_officer:
...
- [prp-bossmenu](https://github.com/ProjectRP-framework/prp-bossmenu) - For the boss menu
- [prp-garages](https://github.com/ProjectRP-framework/prp-garages) - For the vehicle spawner
- [prp-clothing](https://github.com/ProjectRP-framework/prp-clothing) - For the locker room
- [prp-phone](https://github.com/ProjectRP-framework/prp-phone) - For the MEOS app and notifications etc.
- [prp-moneysafe](https://github.com/ProjectRP-framework/prp-moneysafe) - For the money safe
- [prp-log](https://github.com/ProjectRP-framework/prp-logs) - For logging certain events
- [prp-menu](https://github.com/ProjectRP-framework/prp-menu) - For the vehicle menus
- [prp-input](https://github.com/ProjectRP-framework/prp-input) - For accessing evidence stashes
