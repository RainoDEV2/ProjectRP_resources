...
RegisterNetEvent('police:client:policeAlert', function(coords, text)
    ...
    ProjectRP.Functions.Notify({text = text, caption = street1name.. ' ' ..street2name}, 'police')
...
AddEventHandler('police:client:SendPoliceEmergencyAlert', function()
    ...
    TriggerServerEvent("police:server:SendPoliceEmergencyAlert", streetLabel, pos, ProjectRP.Functions.GetPlayerData().metadata["callsign"])
    TriggerServerEvent('prp-policealerts:server:AddPoliceAlert', {
        ...
        details = {
            [1] = {
                ...
                detail = MyId .. ' | ' .. ProjectRP.Functions.GetPlayerData().charinfo.firstname .. ' ' .. ProjectRP.Functions.GetPlayerData().charinfo.lastname,
            },
            [2] = {
