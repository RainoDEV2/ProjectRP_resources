...
RegisterNetEvent('police:client:spawnCone', function()
    ProjectRP.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
...
RegisterNetEvent('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        ProjectRP.Functions.Progressbar("remove_object", "Removing object..", 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
