# decrypto
ATM Hacking with Minigame for ProjectRP Framework

Preview: https://tj-s.online/content/GTAV/decrypto.mp4

## Add items to prp-core\shared\items.lua
...
## Add images to prp-inventory\html\images

- hackcard.png
- decryptomatic.png

## Add a shop to prp-shops\config.lua
