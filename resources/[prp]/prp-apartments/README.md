# prp-apartments
Apartments System for prp-Core Framework :office:
...
- [prp-clothing](https://github.com/ProjectRP-framework/prp-clothing) - To save outfits
- [prp-houses](https://github.com/ProjectRP-framework/prp-houses) - House logic
- [prp-interior](https://github.com/ProjectRP-framework/prp-interior) - Interior logic
- [prp-weathersync](https://github.com/ProjectRP-framework/prp-weathersync) - To desync weather while inside
- [prp-spawn](https://github.com/ProjectRP-framework/prp-spawn) - To spawn the player at apartment if last location was in apartment
...
- Import `prp-apartments.sql` in your database
