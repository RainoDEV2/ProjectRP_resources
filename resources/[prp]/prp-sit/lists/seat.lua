Config.Sitable = {
	...
	gabz_pillbox_diagnostics_bed_02	= { scenario = 'WORLD_HUMAN_SUNBATHE', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	gabz_pillbox_diagnostics_bed_03	= { scenario = 'WORLD_HUMAN_SUNBATHE', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	gabz_pillbox_MRI_bed			= { scenario = 'WORLD_HUMAN_SUNBATHE', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	v_med_bed2					= { scenario = 'WORLD_HUMAN_SUNBATHE', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	v_med_emptybed					= { scenario = 'WORLD_HUMAN_SUNBATHE', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	v_med_bed1					= { scenario = 'WORLD_HUMAN_SUNBATHE', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
}
