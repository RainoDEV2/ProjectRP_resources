...
local function findVehFromPlateAndLocate(plate)
    local gameVehicles = ProjectRP.Functions.GetVehicles()
    for i = 1, #gameVehicles do
        local vehicle = gameVehicles[i]
        if DoesEntityExist(vehicle) then
            if ProjectRP.Functions.GetPlate(vehicle) == plate then
...
local function LoadPhone()
    Wait(100)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetPhoneData', function(pData)
...
local function OpenPhone()
    ProjectRP.Functions.TriggerCallback('prp-phone:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            ProjectRP.Functions.Notify("You don't have a phone", "error")
        end
    end)
end
...
RegisterCommand('phone', function()
    ...
    if not PhoneData.isOpen and LocalPlayer.state.isLoggedIn then
        if not PlayerData.metadata['ishandcuffed'] and not PlayerData.metadata['inlaststand'] and not PlayerData.metadata['isdead'] and not IsPauseMenuActive() then
            ...
            ProjectRP.Functions.Notify("Action not available at the moment..", "error")
        end
    end
end)
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    ProjectRP.Functions.TriggerCallback('prp-phone:server:PayInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    ProjectRP.Functions.TriggerCallback('prp-phone:server:DeclineInvoice', function(CanPay, Invoices)
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('GetTruckerData', function(data, cb)
    local TruckerMeta = ProjectRP.Functions.GetPlayerData().metadata["jobrep"]["trucker"]
    local TierData = exports['prp-trucker']:GetTier(TruckerMeta)
    cb(TierData)
end)
...
RegisterNUICallback('track-vehicle', function(data, cb)
    ...
    if findVehFromPlateAndLocate(veh.plate) then
        ProjectRP.Functions.Notify("Your vehicle has been marked", "success")
    else
        ProjectRP.Functions.Notify("This vehicle cannot be located", "error")
    end
end)
...
RegisterNUICallback('GetCryptoData', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-crypto:server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-crypto:server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-crypto:server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-crypto:server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)
...
RegisterNUICallback('SetAlertWaypoint', function(data)
    ...
    ProjectRP.Functions.Notify('GPS Location set: '..data.alert.title)
...
RegisterNUICallback('FetchVehicleResults', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetVehicleSearchResults', function(result)
        if result ~= nil then
            for k, v in pairs(result) do
                ProjectRP.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    ProjectRP.Functions.TriggerCallback('prp-phone:server:ScanPlate', function(result)
        ProjectRP.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
            result.isFlagged = flagged
	    if ProjectRP.Shared.Vehicles[vehname] ~= nil then
                result.label = ProjectRP.Shared.Vehicles[vehname]['name']
            else
...
RegisterNUICallback('GetRaces', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('HasCreatedRace', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
...
RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:GetRacingData', function(RaceData)
        ...
        if dist <= 115.0 then
            ...
            ProjectRP.Functions.Notify('You\'re too far away from the race. GPS has been set to the race.', 'error', 5000)
...
RegisterNUICallback('CanRaceSetup', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)

RegisterNUICallback('GetPlayerHouses', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end)
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)
...
RegisterNUICallback('SetHouseLocation', function(data, cb)
    ...
    ProjectRP.Functions.Notify("GPS has been set to " .. data.HouseData.HouseData.adress .. "!", "success")
end)
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    ProjectRP.Functions.TriggerCallback('prp-phone:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
    end, TransferedCid, data.HouseData)
end)

RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('SetGPSLocation', function(data, cb)
    ...
    ProjectRP.Functions.Notify('GPS has been set!', 'success')
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)
...
RegisterNUICallback('CanTransferMoney', function(data, cb)
    ...
    if (PlayerData.money.bank - amount) >= 0 then
        ProjectRP.Functions.TriggerCallback('prp-phone:server:CanTransferMoney', function(Transferd)
            if Transferd then
...
RegisterNUICallback('CallContact', function(data, cb)
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetCallState', function(CanCall, IsOnline, contactData)
        local status = {
            CanCall = CanCall,
            IsOnline = IsOnline,
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    ProjectRP.Functions.TriggerCallback('prp-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNetEvent('prp-phone:client:AddTransaction', function(SenderData, TransactionData, Message, Title)
    local Data = {
