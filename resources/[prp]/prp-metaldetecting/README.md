...
## Dependencies
- <a href="https://github.com/qbcore-framework/prp-core">**prp-core**</a>
- <a href="https://github.com/qbcore-framework/prp-menu">**prp-menu**</a>
- <a href="https://github.com/BerkieBb/prp-target">**prp-target**</a>
...
- Insert this line into your prp-shops > config.lua (wherever you want it), ensure you change the array index & slot #'s to match your config.
...
**3.** Insert this list of items in your prp-core > shared > items.lua
<pre>-- prp-metaldetecting 
