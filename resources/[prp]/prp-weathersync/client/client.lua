...
RegisterNetEvent('ProjectRP:Client:OnPlayerLoaded', function()
    ...
    TriggerServerEvent('prp-weathersync:server:RequestCommands')
end)

RegisterNetEvent('prp-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('prp-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('prp-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('prp-weathersync:client:SyncWeather', function(NewWeather, newblackout)
...
RegisterNetEvent('prp-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
