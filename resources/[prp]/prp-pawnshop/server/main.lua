local ItemList = {
    ["goldchain"] = math.random(300, 400),
    ["diamond_ring"] = math.random(500, 800),
    ["rolex"] = math.random(250, 300),
    ["10kgoldchain"] = math.random(300, 400),
}
...
local ItemListHardware = {
    ...
    ["laptop"] = math.random(100, 150),
    ["gameboy"] = math.random(200, 250),
}
