# Vehicle Rental Script for ProjectRP Framework

* [Overtime Development](https://discord.gg/MeBxzrGtyY)
* [ProjectRP Discord](discord.gg/qbcore)
...
* Find this in **prp-target/config**
...
```
# Rental Papers Item - prp-core/shared.lua
...
```
# Rental Papers Item Description - prp-inventory/html/js/app.js (Line 577)
...
### 1.1
* Added prp-target export / prp-menu
