...
RegisterNetEvent("prp-fishing:tryToFish")
AddEventHandler("prp-fishing:tryToFish", function()
	TryToFish() 
end)

RegisterNetEvent("prp-fishing:calculatedistances")
AddEventHandler("prp-fishing:calculatedistances", pos, function()
