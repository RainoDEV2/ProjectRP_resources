...
-- OPTION 1
-- Use these queries on your database if you are converting your existing prp-lapraces table to prp-racing
...
-- OPTION 2
-- Use this if you have not used prp-lapraces and dont have races to convert
