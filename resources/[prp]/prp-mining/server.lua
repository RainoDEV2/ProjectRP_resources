...
AddEventHandler('prp-mining:Smelting:Reward', function(data)
	...
	if data == 1 then
		...
		TriggerClientEvent('inventory:client:ItemBox', src, ProjectRP.Shared.Items["copper"], 'add', 8)
	elseif data == 2 then
	...
	elseif data == 3 then
		...
		TriggerClientEvent('inventory:client:ItemBox', src, ProjectRP.Shared.Items["iron"], 'add', 6)
	elseif data == 4 then
		Player.Functions.RemoveItem('ironore', 1)
