...
Config = {
    ...
    PropertyResell = 0.3, -- the % you get back of the original price when selling a property, 1 = 100%
    ...
    Inventory = "default", --[[
        default - default housing, esx: menu based, prp-core: default prp-inventory
