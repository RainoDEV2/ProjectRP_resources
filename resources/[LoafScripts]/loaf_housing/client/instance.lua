...
RegisterNetEvent("loaf_housing:enter_instance", function(data)
    ...
    TriggerEvent("prp-anticheat:client:ToggleDecorate", true) -- disable prp-anticheat invisible check. prp devs, pls make this a server event instead so cheaters cant abuse :)
