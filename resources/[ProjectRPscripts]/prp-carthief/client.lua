...
--             Citizen.Wait(500)
--             ProjectRP.Functions.TriggerCallback('prp-carthief:PoliceOnDuty', function(police)
--                 PoliceCount = police
--             end)
--         Citizen.Wait(sleep)
--     end
                        ...
                        elseif hasParked then
                            if whatNext then
                                ...
                                elseif IsControlJustReleased(0, Keys['B']) then
                                    ...
                                    Citizen.Wait(2000)
                                    TriggerServerEvent('prp-carthief:Payout', CarsToSteal.Payout, 0.5, CarsToSteal.CarLabel)
                                    ClearPedTasks(ped)
                                    ClearPedTasks(boss)
                                    AskBossText = nil
                                    BossCarText = nil
                    ...
                    elseif hasComingGarage then
                        if WheelsCount > 0 and CarBodyCount > 0 and EngineCount > 0 then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                ...
                                TaskPlayAnim(boss, 'mp_common', 'givetake1_a', 8.0, -8.0, -1, 2, 0, false, false, false)
                                Citizen.Wait(2000)
                                TriggerServerEvent('prp-carthief:Payout', CarsToSteal.Payout, 1.0, CarsToSteal.CarLabel)
                                startedWork = false
                                EngineCount = 1
                                WheelsCount = 4
                                CarBodyCount = 6
