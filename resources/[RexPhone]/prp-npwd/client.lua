...
RegisterNetEvent('ProjectRP:Client:OnPlayerLoaded', function()
    DoPhoneCheck(ProjectRP.Functions.GetPlayerData().items)
end)
...
RegisterNetEvent('ProjectRP:Player:SetPlayerData', function(PlayerData)
...
RegisterNetEvent('prp-npwd:client:setPhoneVisible', function(isPhoneVisible)
