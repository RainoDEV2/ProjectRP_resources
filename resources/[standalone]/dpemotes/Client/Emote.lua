...
AddEventHandler('animations:client:EmoteCommandStart', function(args)
  if CanDoEmote then
    ...
    ProjectRP.Functions.Notify("Cannot Be Done Right Now", "error")
  end
end)
...
function EmoteCommandStart(source, args, raw)
    ...
    if name == "c" then
        if IsInAnimation then
          ...
          ProjectRP.Functions.Notify('No Emote To Cancel', 'error')
        end
      return
    ...
    elseif DP.PropEmotes[name] ~= nil then
      ...
      ProjectRP.Functions.Notify('That Is Not A Valid Command', 'error')
    end
  end
end
