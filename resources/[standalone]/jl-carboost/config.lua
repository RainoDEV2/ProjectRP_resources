...
Config.Alert = 'prp-dispatch' -- prp-dispatch / linden_outlawalert / notification, only use prp-dispatch when its on stable release

Config.Inventory = 'prp-inventory/html/images/' -- prp-inventory/html/images/
...
Config.VINChance = 0.25 -- chance police to find out the VIN is scratched or no
