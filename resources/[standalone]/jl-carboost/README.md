...
2. Go to your prp-core/server/player.lua, and find `ProjectRP.Player.CheckPlayerData function` and paste this snippets
...
3. Go to your prp-core/shared/items.lua, and add this
...
4. Go to your `prp-radialmenu/config.lua` and add this on policejob, probably line 711
...
5. Go to your `prp-vehicleshop/server.lua` find this event `prp-vehicleshop:server:buyShowroomVehicle`, replace that with
